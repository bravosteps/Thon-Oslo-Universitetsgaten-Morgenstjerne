namespace BiampTesiraLib3.Tesira_Support;
        // class declarations
         ...
         class SubscriptionUpdateIntervalMap;
         class ProtocolUtil;
     ...
     class TesiraProtocolInfo 
    {
        ...
        INTEGER Index1;
        INTEGER Index2;
        SIGNED_LONG_INTEGER SubscriptionUpdateInterval;
    };
     ...
     class SubscriptionUpdateIntervalMap 
    {
        ...
        // class variables
        static BiampTesiraLib3.Tesira_Support.SubscriptionUpdateIntervalMap NONE;
        static BiampTesiraLib3.Tesira_Support.SubscriptionUpdateIntervalMap INTERVAL_100;
        static BiampTesiraLib3.Tesira_Support.SubscriptionUpdateIntervalMap INTERVAL_250;
        static BiampTesiraLib3.Tesira_Support.SubscriptionUpdateIntervalMap INTERVAL_300;
        static BiampTesiraLib3.Tesira_Support.SubscriptionUpdateIntervalMap INTERVAL_500;
        static BiampTesiraLib3.Tesira_Support.SubscriptionUpdateIntervalMap INTERVAL_1000;
        static BiampTesiraLib3.Tesira_Support.SubscriptionUpdateIntervalMap UNKNOWN;
...
namespace BiampTesiraLib3.Components;
     ...
     class GenericComponent 
    {
        ...
        FUNCTION SetSubscriptionUpdateInterval ( INTEGER value );
        FUNCTION UnRegister ();
